...
static const uint32_t LRF_commonRegConfig[] =
{
    ...
    0x202A5001,                       //     RAM 16-bit region (start address = 0x202A, count = 2)
    ...
    0x20320197,                       //         PBE_BLE5_RAM.FIFOCFG
    0x20360002,                       //         PBE_BLE5_RAM.NAKHUB
...
static const uint32_t LRF_subPhyCodedRegConfig[] =
{
    ...
    0x20205004,                       //     RAM 16-bit region (start address = 0x2020, count = 5)
